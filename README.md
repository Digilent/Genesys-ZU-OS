...
This is a simple Petalinux base project with the Zynq Ultrascale+ MPSoc configured with the given Vivado board file. The SATA is enabled on GT lane 0 instead of PCIe.
